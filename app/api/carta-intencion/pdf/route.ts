...
import { buildCartaIntencionPdf } from "@/lib/cartaIntencionPdf";
...
export async function GET(request: Request) {
  ...
  const pdf = await buildCartaIntencionPdf({
    carta: doc.cartas?.intencion,
    firma: doc.firma,
  });
  ...
  return new Response(pdf as BodyInit, {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="MSE-FO-29-Carta-Intencion-${nombre}.pdf"`,
