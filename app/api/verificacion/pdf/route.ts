...
import { buildVerificacionPdf } from "@/lib/verificacionPdf";
...
export async function GET(request: Request) {
  ...
  const pdf = await buildVerificacionPdf({
  ...
  return new Response(pdf as BodyInit, {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="Lista-Verificacion-${nombre}.pdf"`,
